    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div
        ...
        style={{
          ...
          opacity: 0.7, // Keep the transparency
          filter: "grayscale(100%) contrast(1.05) brightness(1.05)", // Added grayscale
        }}
      />
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(135deg, rgba(255,255,255,0.5) 0%, rgba(255,255,255,0.5) 30%, rgba(255,255,255,0.5) 70%, rgba(255,255,255,0.5) 100%)",
          pointerEvents: "none",
          backdropFilter:
            "blur(1px)" /* Very subtle blur for depth without obscuring details */,
        }}
      />
          ...
          >
            ...
            >
              <p
                ...
                style={{ color: "rgb(76,74,75)", letterSpacing: "0.05em" }}
              >
                INDEPENDENT 2ND OPINION CONSULTING
                <br />
