...
const HowSection = () => {
  const methods = [
    ...
    {
      icon: <Lightbulb className="h-12 w-12" style={{ color: 'rgb(76,74,75)' }} />,
    ...
    {
      icon: <Shield className="h-12 w-12" style={{ color: 'rgb(76,74,75)' }} />,
    ...
    {
      icon: <TrendingUp className="h-12 w-12" style={{ color: 'rgb(76,74,75)' }} />,
  ...
  return (
    <section id="how" className="py-20 relative">
      ...
      <div 
        ...
        style={{
          backgroundImage: 'url("/images/how/how-bg.jpg")',
          backgroundSize: 'cover',
          backgroundPosition: 'center',
          backgroundRepeat: 'no-repeat',
          filter: 'grayscale(1)' // Grayscale only applied to this background div
        }}
      ></div>
      
      {/* Increased white overlay for better readability and stronger washout effect */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20">
            ...
            >
              ...
              >
                ...
                <div className="relative h-full p-5 flex flex-col justify-center">
                  <h3 className="text-xl group-hover:text-2xl font-league-spartan font-bold mb-4 transition-all duration-300" style={{ color: 'rgb(0,0,0)' }}>
                    <span style={{ color: 'rgb(0,0,0)' }}>{method.title.split(' ')[0]}</span>{' '}
                    <span style={{ color: 'rgb(0,0,0)' }}>{method.title.split(' ').slice(1).join(' ')}</span>
                  </h3>
        ...
        >
          ...
          >
            From <span style={{ color: 'rgb(0,0,0)', fontWeight: '500' }}>concept validation</span> to <span style={{ color: 'rgb(0,0,0)', fontWeight: '500' }}>final handover</span>, we make sure your project is not only well-designed on paper but also successful in reality.
          </p>
        </motion.div>

        {/* Bottom CTA with enhanced shadow */}
        <motion.div
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8 }}
